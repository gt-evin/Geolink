package com.example.wazitoecommerce.ui.theme.screens.adminlogin
...
import com.example.wazitoecommerce.navigation.ADMINSIGN_URL
...
fun AdminLoginScreen(navController:NavHostController){
    Column(
        ...
        Image(painter = painterResource(id = R.drawable.pp), contentDescription = "reg")
        ...
        Text(text = "Not Admin?Register",
            modifier = Modifier
                .clickable { navController.navigate(ADMINSIGN_URL) },
            fontSize = 15.sp,
